...
namespace Book_Store_.Controllers
{
    public class BooksController : Controller
    {
        private readonly Book_Store_Context _context;

        public BooksController(Book_Store_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Books != null ? 
                          ...
                          Problem("Entity set 'Book_Store_Context.Books'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Book_Store_Context.Books'  is null.");
            }
            var book = await _context.Books.FindAsync(id);
            if (book != null)
            {
